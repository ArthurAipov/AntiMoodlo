...
--
-- Name: block_blockid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.block_blockid_seq OWNER TO postgres;

--
-- Name: block_blockid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: correctanswers_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.correctanswers_id_seq OWNER TO postgres;

--
-- Name: correctanswers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: matchpairs; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.matchpairs OWNER TO postgres;

--
-- Name: matchpairs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.matchpairs_id_seq OWNER TO postgres;

--
-- Name: matchpairs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: openanswers; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.openanswers OWNER TO postgres;

--
-- Name: openanswers_question_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.openanswers_question_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.openanswers_question_id_seq OWNER TO postgres;

--
-- Name: openanswers_question_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.openanswers_question_id_seq OWNED BY public.openanswers.question_id;
...
--
-- Name: questionoptions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.questionoptions_id_seq OWNER TO postgres;

--
-- Name: questionoptions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: questiontypes; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.questiontypes OWNER TO postgres;

--
-- Name: questiontypes_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.questiontypes_id_seq OWNER TO postgres;

--
-- Name: questiontypes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: usercourse_user_course_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.usercourse_user_course_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.usercourse_user_course_id_seq OWNER TO postgres;

--
-- Name: usercourse_user_course_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.usercourse_user_course_id_seq OWNED BY public.usercourse.user_course_id;


--
-- Name: usercourse_usercourseid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.usercourse_usercourseid_seq OWNER TO postgres;

--
-- Name: usercourse_usercourseid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: userroles_role_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.userroles_role_id_seq OWNER TO postgres;

--
-- Name: userroles_role_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: block blockid; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: correctanswers id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: matchpairs id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: openanswers question_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.openanswers ALTER COLUMN question_id SET DEFAULT nextval('public.openanswers_question_id_seq'::regclass);


--
-- Name: questionoptions id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: questiontypes id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: usercourse usercourseid; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: usercourse user_course_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.usercourse ALTER COLUMN user_course_id SET DEFAULT nextval('public.usercourse_user_course_id_seq'::regclass);
...
--
-- Name: userroles role_id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
COPY public.course (courseid, title, course_id) FROM stdin;
1	Math 101	1
2	Physics Basics	2
3	History of Art	3
\.
...
--
-- Data for Name: matchpairs; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: openanswers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.openanswers (questionid, answertext, question_id, answer_text) FROM stdin;
3	It is a period of revival in arts and science.	1	\N
\.
...
COPY public.questionoptions (id, questionid, optiontext, question_id, option_text) FROM stdin;
1	1	4	\N	\N
2	1	3	\N	\N
3	1	5	\N	\N
4	2	2	\N	\N
...
COPY public.questions (id, quizid, questiontext, questiontypeid, question_typeid) FROM stdin;
1	1	What is 2 + 2?	1	\N
2	2	Choose all even numbers	2	\N
3	3	Explain Renaissance art.	3	\N
\.


--
-- Data for Name: questiontypes; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
COPY public.quizzes (id, title, maxgrade, duration, stateid, startdate, enddate, submiteddate, courseid, end_date, course_id) FROM stdin;
1	Midterm Quiz	100	60	2	2025-06-13 02:44:29.536886	2025-06-20 02:44:29.536886	\N	1	\N	\N
2	Final Quiz	100	90	2	2025-06-13 02:44:29.536886	2025-06-23 02:44:29.536886	\N	2	\N	\N
3	Practice Quiz	50	30	1	2025-06-13 02:44:29.536886	2025-06-16 02:44:29.536886	\N	3	\N	\N
\.
...
COPY public.usercourse (usercourseid, userid, courseid, grade, lettergrade, user_course_id) FROM stdin;
1	1	1	90	A	1
2	2	2	75	C	2
3	3	3	85	B	3
\.
...
COPY public.userroles (roleid, rolename, role_id) FROM stdin;
1	Student	1
2	Teacher	2
3	Admin	3
\.
...
COPY public.users (userid, userlogin, userpassword, userrole, user_id) FROM stdin;
1	alice	password123	1	1
2	bob	secure456	2	2
3	charlie	admin789	3	3
\.


--
-- Name: block_blockid_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: correctanswers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: matchpairs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: openanswers_question_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.openanswers_question_id_seq', 1, true);


--
-- Name: questionoptions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: questiontypes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: usercourse_user_course_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.usercourse_user_course_id_seq', 3, true);


--
-- Name: usercourse_usercourseid_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: userroles_role_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.userroles_role_id_seq', 3, true);
...
--
-- Name: correctanswers correctanswers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: matchpairs matchpairs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: openanswers openanswers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: questiontypes questiontypes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: correctanswers correctanswers_optionid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: correctanswers correctanswers_questionid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: block fk_blockcourse; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: quizzes fk_course; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: usercourse fk_course; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: usercourse fk_user; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: users fk_userrole; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: matchpairs matchpairs_questionid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: openanswers openanswers_questionid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: questionoptions questionoptions_questionid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: questions questions_questiontypeid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: quizzes quizzes_stateid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
